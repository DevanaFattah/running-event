...
<section class="bg-[#F6E69E] py-20 px-6">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        @foreach($events as $event)
            <div class="bg-[#FFF9F0] rounded-[1.5rem] shadow-xl overflow-hidden flex flex-col border border-white/50 transition-transform hover:scale-[1.02] duration-300">
                ...
                <div class="p-5 pb-0">
                    ...
                    <div class="bg-[#FDBF2D] relative z-10 rounded-b-xl p-3 flex items-center gap-3 shadow-md border border-black/5">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[10px] font-bold text-[#0D5F77]/60 uppercase leading-none">WeatherTech Raceway</span>
                            <span class="text-xs font-black text-[#0D5F77] leading-tight">{{ $event['location'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8 pt-6 flex-grow flex flex-col">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="text-xs font-black text-[#0D5F77] whitespace-nowrap">{{ $event['date'] }}</span>
                    </div>
