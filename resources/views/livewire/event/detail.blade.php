        ...
        <div class="w-full md:w-2/3 bg-[#FFF9F0] rounded-[2.5rem] p-8 md:p-10 shadow-xl">
                ...
                <div class="w-full md:w-1/2">
                    <div class="bg-[#0D5F77] rounded-t-3xl p-4 aspect-video flex items-center justify-center relative">
                        ...
                        <div class="absolute -bottom-5 left-4 right-4 bg-[#FDBF2D] rounded-b-xl p-2 flex items-center gap-2 -mx-4 border border-black/10">
                            ...
                            <span class="text-[10px] font-black text-[#0D5F77] uppercase leading-none">WeatherTech Raceway Laguna Seca</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                <h3 class="text-2xl font-black text-[#0D5F77] uppercase tracking-tighter">
                    TENTANG <span class="text-[#FDBF2D]">TAHUN BARU(A)N</span>
                </h3>
            ...
            <div class="bg-[#FFF9F0] rounded-[2.5rem] p-8 shadow-xl space-y-8">
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <span class="text-sm font-bold text-[#0D5F77] leading-tight">{{ $location }}</span>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="bg-[#0D5F77] p-2 rounded-lg text-white">
                            <flux:icon.calendar class="w-5 h-5" />
                        </div>
                        <span class="text-sm font-bold text-[#0D5F77]">{{ $date }}</span>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="bg-[#0D5F77] p-2 rounded-lg text-white">
                            <flux:icon.ticket class="w-5 h-5" />
                        </div>
                        <span class="text-sm font-bold text-[#0D5F77]">{{ $price }}</span>
                    </div>
                </div>

                <button class="w-full bg-[#FDBF2D] hover:bg-[#eab028] text-[#0D5F77] font-black py-4 rounded-2xl shadow-md uppercase tracking-widest text-sm transition-all active:scale-95">
                    Melu Playon!
                </button>
            </div>
        </div>
